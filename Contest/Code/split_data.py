...
def split():
    ...
    """
    credit_data = pd.read_csv('../Data/creditcard.csv', header=0)

    print('Raw data: \n ', 'Shape: ', credit_data.shape, 'Type: ', type(credit_data))
    ...
    (X_train, X_test, y_train, y_test) = ms.train_test_split(X, y, test_size=.96, random_state=1, stratify=y)
