...
from Code.models import lda, qda, val_rda, logistic_regresion, naive_bayes, val_rf, val_knn, val_perceptron,xgboost, val_mlp
import pickle
import gc
...
def main():
	...
	init = time()
	val_mlp(X_train, X_test, X_val, y_train, y_test, y_val)
	print('mlp time', time() - init)
